...
%%	Faixa Zenith primeira página 			   			 background
	...
	\else
		\backgroundsetup{
			contents=\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{DEPENDENCES/zenith-faixa.png}},
			scale=1,
			placement=top,
			opacity=1
		}
...
\ifdraft
	\rhead{}
\else
	\rhead{\includegraphics[height=0.020\textheight]{DEPENDENCES/LogoZ.jpg}}
\fi
\rfoot{\thepage}
...
\begin{titlepage}
	...
	\begin{figure}[h]
	\centering
	\includegraphics[scale=0.1]{DEPENDENCES/LogoZ.jpg}
	\end{figure}
